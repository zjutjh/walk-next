...
/** 人员行进状态的中文名 */
export const MEMBER_WALK_STATUS_TEXT = {
  not_start: "未开始",
  pending: "待出发",
  in_progress: "进行中",
  abandoned: "已放弃",
...
/** 人员统计指标的中文名 */
export const MEMBER_STATS_METRIC_TEXT = {
  total_reg: "总报名",
  not_present: "未到场",
  pending: MEMBER_WALK_STATUS_TEXT.pending,
  in_progress: MEMBER_WALK_STATUS_TEXT.in_progress,
  finished: "已结束",
  withdrawn: "下撤",
  wrong_route: "走错路线"
